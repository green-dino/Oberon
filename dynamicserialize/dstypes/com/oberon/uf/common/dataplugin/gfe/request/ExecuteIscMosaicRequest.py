...
from dynamicserialize.dstypes.com.oberon.uf.common.message import WsId
...
class ExecuteIscMosaicRequest(AbstractGfeRequest):
    ...
    def __init__(self, userID=None, databaseID=None, parmsToProcess=[], 
                 ...
                 gridDelay=0.0, logFileName=None, additionalRoutingSiteID=None,
                 asynchronous=False):
        ...
        self.additionalRoutingSiteID = additionalRoutingSiteID
    ...
    def __str__(self):
        ...
        retVal += "additionalRoutingSiteID: " + str(self.additionalRoutingSiteID) + ", "
        retVal += "asynchronous: " + str(self.asynchronous) + "]"
        return retVal
    ...
    def getAdditionalRoutingSiteID(self):
        return self.additionalRoutingSiteID

    def setAdditionalRoutingSiteID(self, additionalRoutingSiteID):
        self.additionalRoutingSiteID = additionalRoutingSiteID
