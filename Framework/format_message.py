KEYNAMES = [
    ...
    "discovery_method.external.variety",
    "discovery_method.internal.variety",
    ...
    for key in KEYNAMES:
        if key in incident_data:
            message_lines.append(
                f"{key.replace('.', ' ').capitalize()}: {incident_data[key]}"
            )
        else:
