...
class PageBlock:
    ...
    def __repr__(self) -> str:
        return (
            f"PageBlock(page_size={self.page_size}, page_type='{self.page_type}', page_id={self.page_id}, "
...
if __name__ == "__main__":
    page_entries = [
        PageEntry(1, bytes([0x10, 0x00, 0x00, 0x00])),
        PageEntry(2, bytes([0x00, 0x00, 0x00, 0x00])),
    ]
    page_size = 2048
    page_id = 1
    list_id = 100
