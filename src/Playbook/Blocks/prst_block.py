...
class PRSTBlock:
    ...
    def parse(self):
        ...
        self.page_setup_size, self.page_setup_type, self.page_setup_id, self.filler = (
            header
        )
        ...
        (
            ...
            self.spool_file_volume,
            self.spool_file_version,
            self.reserved6,
            self.reserved7,
            self.reserved8,
            self.reserved9,
    ...
    def __repr__(self):
        return (
            f"PRSTBlock(page_setup_size={self.page_setup_size}, page_setup_type={self.page_setup_type}, "
