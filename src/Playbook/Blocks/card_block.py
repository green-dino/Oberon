...
class CardBlock:
    ...
    def __repr__(self) -> str:
        return (
            f"CardBlock(card_size={self.card_size}, card_type='{self.card_type}', card_id={self.card_id}, "
...
if __name__ == "__main__":
    ...
    card_block = create_card_block(
        2048, 1, 2, 0, 3, 4, parts, part_contents, "Card1", "Script1"
    )
