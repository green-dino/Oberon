...
class ListBlock:
    def __init__(
        ...
        page_count: int,
        page_size: int,
        page_entry_total: int,
        page_entry_size: int,
        something1: int,
        something2: int,
        something3: int,
        something4: int,
        page_entry_total_2: int,
        something5: int,
        pages: List[Page],
    ):
    ...
    def __repr__(self) -> str:
        return (
            f"ListBlock(list_size={self.list_size}, list_type='{self.list_type}', list_id={self.list_id}, "
...
if __name__ == "__main__":
    ...
    list_block = create_list_block(
        list_size, page_count, page_size, page_entry_total, page_entry_size, pages
    )
