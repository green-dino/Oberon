...
class RequestedBy:
    def __init__(self, name: str, position: str) -> None:
        ...
        logging.info(
            f"Initialized RequestedBy with name: {self.name}, position: {self.position}"
        )
...
class DescriptionOfChange:
    def __init__(self, description: str) -> None:
        ...
        logging.info(
            f"Initialized DescriptionOfChange with description: {self.description}"
        )
...
class JustificationForChange:
    def __init__(self, justification: str) -> None:
        ...
        logging.info(
            f"Initialized JustificationForChange with justification: {self.justification}"
        )
...
class ImpactAssessment:
    def __init__(self, risks: str, mitigation_measures: str) -> None:
        ...
        logging.info(
            f"Initialized ImpactAssessment with risks: {self.risks}, mitigation_measures: {self.mitigation_measures}"
        )
...
class ChangeImplementationDate:
    def __init__(self, date_time: str) -> None:
        ...
        logging.info(
            f"Initialized ChangeImplementationDate with date_time: {self.date_time}"
        )
...
class ChangeApprover:
    def __init__(self, approver: str, approval_date: str) -> None:
        ...
        logging.info(
            f"Initialized ChangeApprover with approver: {self.approver}, approval_date: {self.approval_date}"
        )
