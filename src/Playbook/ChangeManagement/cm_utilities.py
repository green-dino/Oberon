...
class DocumentControlInformation:
    def __init__(
        self, title, number, history, last_revision_date, owner, distribution_list
    ):
...
class ChangeImplementationPlan:
    def __init__(
        self, scope, steps, resources, timeline, testing_procedures, rollback_plan
    ):
...
class ChangeControlRecord:
    def __init__(
        ...
        self.impact_assessment = ImpactAssessment(
            impact["risks"], impact["mitigation_measures"]
        )
        ...
        self.change_approver = ChangeApprover(
            approver["name"], approver["approval_date"]
        )
