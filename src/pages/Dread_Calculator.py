...
class RiskAssessment:
    ...
    def __init__(
        self, damage, reproducibility, exploitability, affected_users, discoverability
    ):
        self.damage = damage
    ...
    def calculate_dread_risk(self):
        ...
        scaled_risk_value = min(
            (np.log1p(weighted_sum) / np.log1p(10)) * self.DREAD_RISK_CAP,
            self.DREAD_RISK_CAP,
        )
    ...
    def assess_risk(self):
        if (
            ...
            st.error(
                "Input values must be in the range 0-10 for Damage, Reproducibility, Exploitability, Discoverability, and 0-100 for Affected Users."
            )
            return False
    ...
    def take_actions_for_high_risk(self):
        return [
            ...
            "Allocate necessary resources to address the issue.",
